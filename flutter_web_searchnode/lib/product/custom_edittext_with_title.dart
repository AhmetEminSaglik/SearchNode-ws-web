...
InputFieldWithTitle({String title="", required TextEditingController controller,String hintText=""}) {
  return Padding(
...
Widget CustomTextField({required TextEditingController controller, String hintText=""} ) {
